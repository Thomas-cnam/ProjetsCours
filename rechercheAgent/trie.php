...
<body>
    <a href="index.php"><button id="Retour">Retour</button></a>
    <a href="pageTableau.php"><button id="page">PAGE</button></a>
    <button type="button" class="btn js-btn-filtre" data-value="CUGR">CUGR</button>
    <button type="button" class="btn js-btn-filtre" data-value="VDR">VDR</button>
    <button type="button" class="btn js-btn-filtre" data-value="CDE">CDE</button>
    <button type="button" class="btn js-btn-filtre" data-value="CCAS">CCAS</button>
    <button type="button" class="btn js-btn-filtre" data-value="ESAD">ESAD</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.js-btn-filtre').on('click', function(e){
                var cdeta = $(this).data('value')
                dt.ajax.url('Ajax/Ajax2.php?cdeta=' + cdeta).load()
            })
        });
